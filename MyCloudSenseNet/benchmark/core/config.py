...
DATA_DIR: Final[Path] = Path.cwd().parent.resolve() / "data"
...
# Default model weights path (relative to benchmark directory)
DEFAULT_MODEL_WEIGHTS_PATH: Final[Path] = Path("benchmark/unet/assets/cloud_model.pt")
